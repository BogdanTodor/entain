...
var (
	...
	racingGrpcEndpoint = flag.String("racing-grpc-endpoint", "localhost:9000", "gRPC server endpoint")
	sportsGrpcEndpoint = flag.String("sports-grpc-endpoint", "localhost:10000", "gRPC server endpoint")
)
